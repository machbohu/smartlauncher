...
\abstractCS{
Tato práce se zabývá problematikou tvorby speciální platformy pro efektivní spouštění aplikací v závislosti na 
pravidelným aktivitách. Cílem je rozpracovat návrh aplikace pro mobilní zařízení, která přináší inovativní vylepšení stávajících řešení se zaměřením na limitované uživatele (především zrakově postižené) a jejich opakované činnosti.
}
\abstractEN{
This work deals with the creation of a special platform for the efficient running of applications, depending on
regular activities. The aim is to develop a draft application for mobile devices that delivers innovative enhancements to existing solutions with a focus on limited users (especially for visually impaired) and their repetitive activities.
}
\placeForDeclarationOfAuthenticity{V~Praze}
\declarationOfAuthenticityOption{1} %volba Prohlášení
\keywordsCS{Launcher, Accessibility, Kontext, Mobilní zařízení, Google Android, Zrakově postižení}
\keywordsEN{Launcher, Accessibility, Context, Mobile device, Google Android, Visually impaired}

\setcounter{tocdepth}{2}

\begin{document}
\hyphenation{sku-pi-ně plat-for-ma ná-sled-ně sa-mo-zřej-mos-tí a-pli-ka-ce frek-ven-ce vstup-ním vzná-ší-me do-mní-vat spo-leč-ně zra-ko-vě ob-lí-be-nost vý-zkum pa-ra-met-ry sa-mo-zřej-mě vy-u-ží-vá na-pří-klad před-po-klá-da-né ho-dno-ce-ní u-ve-řej-ně-ním po-zi-cích pri-már-ně na-zva-né o-pe-ra-ční pří-stup-nou pří-stup-nos-ti ne-sta-čí na-pros-to do-kon-ce a-pli-ka-cí da-tům ge-ne-ra-ce na-šem fy-zi-cké e-li-mi-no-vat po-sti-že-ný ak-ti-vi-ty po-u-ži-tel-nos-ti čtr-ná-cti-denní u-plat-ně-ní mož-nost a-pli-ka-ci o-bla-stí zřej-mé kon-krét-ní-ho rych-lost spouš-tě-ní po-krý-vá-me po-zi-ce ma-na-ger fle-xi-bil-ní u-pra-ve-né-ho do-po-led-ne cel-ko-vý zmí-ně-né o-svěd-če-ných u-pra-ve-nou pře-psat pro-vá-dě-ny se-řa-ze-ny spu-ště-ní kva-lit-ní po-ško-ze-ním pe-ri-o-dic-kých pří-stup-nost ne-do-ce-ni-tel-nou fle-xi-bi-li-tu mo-du-lu ča-so-vý tes-to-vá-ní}
...
\begin{description}
\item[LogRecord]
slouží jako určitá forma středobodu všech logovacích záznamů a je tedy provázaný se všemi tabulkami, které shromažďují informace o~uživatelské nebo systémové činnosti. Vždy musí mít vazbu na záznam v tabulce Timestamp, který určuje časovou linearitu. Ostatní vazby jsou nepovinné (tedy k danému času nemusí existovat záznamy v ostatních tabulkách), protože není zaručeno, že tyto informace budou v danou chvíli dostupné. Pokud v následujících kapitolách zmiňujeme sousloví \uv{informace o aktuálních...} máme tím na mysli právě záznamy vztažené k tomuto časovému záznamu.
...
\subsection{Listener}
Listener (LocationListener\cite{android_location_listener}) je definován jako interface\cite{interface}, který musí každý modul, usilující o registraci, implementovat. Díky tomu máme jistotu, že jsme nad všemi registrovanými moduly (listenery) schopni zavolat potřebné metody (například metodu spojenou s akcí \uv{nastala změna pozice}). Zároveň tento způsob poskytuje dostatečnou volnost vývojářům, kteří mohou na nastalou situaci reagovat vlastní implementací těchto definovaných metod.
...
\begin{description}
	...
	\item[IDOS] Integrovaný DOpravní Systém
	\item[MHD] Městská Hromadná Doprava
	\item[ORM] Object Related Mapping
...
\begin{figure}
	\dirtree{%
		.1 README.md\DTcomment{stručný popis projektu a obsahu CD}.
		.1 docs.
		.2 master\_thesis\DTcomment{zdrojová forma práce ve formátu \LaTeX{}}.
		.2 pdf\DTcomment{text práce ve formátu PDF}.
		.1 interview\DTcomment{zvukové záznamy uživatelských rozhovorů}.
		.1 source\DTcomment{zdrojové kódy implementace}.
	}
\end{figure}
